...
export const PersonalInfoSchema = d.object({
    fields: {
        ...
        phoneNumber: d.string({
            rules: [
                d.regex("^(\\+31|0)[0-9]{9}$", "Voer een geldig Nederlands telefoonnummer in"),
            ],
        }),
        ...
        postalCode: d.string({
            rules: [
                d.regex("^[1-9][0-9]{3}\\s?[A-Za-z]{2}$", "Voer een geldige postcode in (bijv. 1234 AB)"),
            ],
        }),
        ...
        partnerDateOfBirth: d.date({
            included: d.isIn(d.ref("maritalStatus"), d.v([
...
export const PensionPreferencesSchema = d.object({
    fields: {
        ...
        earlyRetirementAcknowledgement: d.boolean({
            included: d.isIn(d.ref("preferredRetirementAge"), d.v([
                RetirementAge.EARLY_62,
                RetirementAge.EARLY_63,
                RetirementAge.EARLY_64,
                RetirementAge.EARLY_65,
            ])),
            rules: [
                d.equals(d.v(true), "U moet bevestigen dat u de gevolgen van vervroegd pensioen begrijpt"),
            ],
        }),
        ...
        partnerConsentWaiver: d.boolean({
            ...
            rules: [
                d.equals(d.v(true), "Uw partner moet toestemming geven voor het afzien van partnerpensioen"),
            ],
        }),
        ...
        declarationOfAccuracy: d.boolean({
            rules: [
                d.equals(d.v(true), "U moet verklaren dat alle ingevulde gegevens naar waarheid zijn ingevuld"),
            ],
        }),
    },
});
