---
title: Introduction
description: Learn how to install and use dynz for schema validation and forms
---
...
dynz is a TypeScript schema validation that provides serializable type-safe validation with dynamic schemas. It is perfect for creating complex
schemas that power your form logic.
