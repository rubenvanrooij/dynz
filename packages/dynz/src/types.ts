...
export type MinRule<
  T extends number | string | Reference = number | string | Reference,
> = {
...
export type ValueOrRef<
  T extends ValueType | Reference = ValueType | Reference,
> = T;
...
export type ArraySchema<T extends Schema> = BaseSchema<
  [T] extends [never] ? unknown[] : SchemaValues<T>[],
