...
export const sizeTransformerType = "size";

export type SizeTranformer<TValue extends ParamaterValue = never> = {
  type: typeof sizeTransformerType;
 ...
 */
export function size<const T extends ParamaterValue>(value: T): SizeTranformer<T> {
  return {
    type: sizeTransformerType,
    value,
  };
}

export function sizeTransformer(value: ValueType | undefined) {
