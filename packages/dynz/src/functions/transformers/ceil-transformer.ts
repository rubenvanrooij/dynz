...
export const ceilTransformerType = "ceil";

export type CeilTranformer<TValue extends ParamaterValue = never> = {
  type: typeof ceilTransformerType;
 ...
 */
export function ceil<const T extends ParamaterValue>(value: T): CeilTranformer<T> {
  return {
    type: ceilTransformerType,
    value,
  };
}

export function ceilTransformer(value: ValueType | undefined) {
