...
export const tanTransformerType = "tan";

export type TanTranformer<TValue extends ParamaterValue = never> = {
  type: typeof tanTransformerType;
 ...
 */
export function tan<const T extends ParamaterValue>(value: T): TanTranformer<T> {
  return {
    type: tanTransformerType,
    value,
  };
}

export function tanTransformer(value: ValueType | undefined) {
