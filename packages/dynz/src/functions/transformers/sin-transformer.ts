...
export const sinTransformerType = "sin";

export type SinTranformer<TValue extends ParamaterValue = never> = {
  type: typeof sinTransformerType;
 ...
 */
export function sin<const T extends ParamaterValue>(value: T): SinTranformer<T> {
  return {
    type: sinTransformerType,
    value,
  };
}

export function sinTransformer(value: ValueType | undefined) {
