...
export const orPredicateType = "or";

export type OrPredicate<TPredicate extends Predicate[] = never> = {
  type: typeof orPredicateType;
 ...
 */
export function or<const T extends Predicate[]>(...predicates: T): OrPredicate<T> {
  return {
...
export function orPredicate(predicates: Array<boolean | undefined>): boolean {
