...
export const lowerThanPredicateType = "lt";

export type LowerThanPredicate<TLeft extends ParamaterValue = never, TRight extends ParamaterValue = never> = {
  type: typeof lowerThanPredicateType;
...
export function lt<const TLeft extends ParamaterValue, const TRight extends ParamaterValue>(
  left: TLeft,
  right: TRight
): LowerThanPredicate<TLeft, TRight> {
  return {
    type: lowerThanPredicateType,
    left,
    right,
  };
}

export function lowerThanPredicate(left: ValueType | undefined, right: ValueType | undefined): boolean | undefined {
