...
export const greaterThanOrEqualPredicateType = "gte";

export type GreaterThanOrEqualPredicate<TLeft extends ParamaterValue = never, TRight extends ParamaterValue = never> = {
  type: typeof greaterThanOrEqualPredicateType;
...
export function gte<const TLeft extends ParamaterValue, const TRight extends ParamaterValue>(
  left: TLeft,
  right: TRight
): GreaterThanOrEqualPredicate<TLeft, TRight> {
  return {
    type: greaterThanOrEqualPredicateType,
    left,
    right,
  };
}

export function greaterThanOrEqualPredicate(
