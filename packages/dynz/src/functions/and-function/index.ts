...
export const andFunctionType = "and";

export type AndFunction<TPredicate extends Predicate[] = never> = {
  type: typeof andFunctionType;
 ...
 */
export function and<const T extends Predicate[]>(...predicates: T): AndFunction<T> {
  return {
    type: andFunctionType,
    predicates,
  };
}

export function andFunction(predicates: Array<boolean | undefined>): boolean {
