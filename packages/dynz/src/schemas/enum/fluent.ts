...
export type EnumFluent<TEnum extends Enum, TRules extends Rule[], TProps> = {
  ...
  readonly rules: TRules;
    ...
    /** Validates value is not one of forbidden enum members. @param values - Array of forbidden values. @param code - Optional error code */
    notOneOf: <P extends ParamaterValue[]>(
      values: P,
      code?: string
    ...
    setPrivate: <const P extends PrivateConfig>(value: P) => EnumFluent<TEnum, TRules, TProps & { private: P }>;
    /**
