...
describe('resolve', () => {
  describe('isRequired', () => {
    ...
    it('should resolve conditional required based on other field', () => {
      ...
      const requiredResult = isRequired(
        schema.fields.email,
        '$.email',
        { type: 'user' }
      );
      ...
      const notRequiredResult = isRequired(
        schema.fields.email,
        '$.email', 
        { type: 'admin' }
      );
  ...
  describe('isMutable', () => {
    ...
    it('should return false for immutable field', () => {
      ...
      expect(result).toBe(true); // Note: there's a bug in the implementation - it checks 'required' instead of 'mutable'
    });
  });
    ...
    describe('AND condition', () => {
      it('should return true when all conditions are true', () => {
        ...
        const result = resolveCondition(
          condition,
          '$',
          createContext({ type: 'user', age: 25 })
        );
        expect(result).toBe(true);
      });
      ...
      it('should return false when any condition is false', () => {
        ...
        const result = resolveCondition(
          condition,
          '$',
          createContext({ type: 'user', age: 16 })
        );
        expect(result).toBe(false);
      });
    });
    ...
    describe('OR condition', () => {
      it('should return true when any condition is true', () => {
        ...
        const result = resolveCondition(
          condition,
          '$',
          createContext({ type: 'user', age: 70 })
        );
        expect(result).toBe(true);
      });
      ...
      it('should return false when all conditions are false', () => {
        ...
        const result = resolveCondition(
          condition,
          '$',
          createContext({ type: 'user', age: 30 })
        );
        expect(result).toBe(false);
      });
    });
